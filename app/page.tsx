    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-zinc-50 font-sans dark:bg-black p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-4xl">
        <Link 
          ...
          className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-center text-white shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
        >
        ...
        <Link 
          ...
          className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 p-6 text-center text-white shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
        >
        ...
        <Link 
          ...
          className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 to-rose-600 p-6 text-center text-white shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
        >
